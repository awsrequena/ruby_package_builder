...
default[:package_builder][:ruby][:deb][:package_name] = "ruby1.9_#{node[:package_builder][:ruby][:version]}-#{node[:package_builder][:ruby][:patch_level]}.#{node[:package_builder][:ruby][:deb][:pkgrelease]}_#{node[:package_builder][:deb][:arch]}.deb"
...
default[:package_builder][:ruby][:rpm][:package_name] = "ruby1.9_#{node[:package_builder][:ruby][:version]}-#{node[:package_builder][:ruby][:patch_level]}.#{node[:package_builder][:ruby][:rpm][:pkgrelease]}_#{node[:package_builder][:rpm][:arch]}.rpm"

...
default[:ruby_package_builder][:rpm][:package_url] = "#{node[:ruby_package_builder][:rpm][:base_url]}/#{node[:ruby_package_builder][:rpm][:basename].match(/.\../)[0]}/#{node[:ruby_package_builder][:rpm][:basename]}.tar.bz2"
